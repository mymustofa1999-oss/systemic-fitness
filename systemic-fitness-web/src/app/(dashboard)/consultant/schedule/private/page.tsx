...
import { Calendar, Settings2, User } from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-2">
            ...
            <span>Consultant / My Schedule / Private Consultation</span>
          </div>
          <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
            <User className="h-6 w-6 text-sf-deepNavy" />
            Private Consultation
          </h1>
          <p className="text-slate-500 text-sm mt-1">Manage your private consultation schedule here.</p>
        </div>
