...
import { UsersRound, Settings2, Smartphone, Users } from "lucide-react";

export default function DigitalGTPage() {
  return (
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-2">
            ...
            <span>Consultant / My Clients / Digital / Group Training</span>
          </div>
          <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
            <Smartphone className="h-6 w-6 text-sf-deepNavy" />
            <Users className="h-5 w-5 text-sf-deepNavy" />
            Digital - Group Training
          </h1>
          <p className="text-slate-500 text-sm mt-1">Manage your digital group training clients here.</p>
        </div>
