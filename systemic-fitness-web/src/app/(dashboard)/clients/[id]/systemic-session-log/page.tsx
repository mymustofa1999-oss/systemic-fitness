              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-sm mb-2"
                    ...
                    <option value="Well Hydrated — more than 1.5 L">Well Hydrated — more than 1.5 L</option>
                    <option value="Mildly Dehydrated — around 1-1.5 L">Mildly Dehydrated — around 1-1.5 L</option>
                    <option value="Poor Hydration — less than 1 L">Poor Hydration — less than 1 L</option>
                  </select>
                ...
                <div>
                  ...
                  <select className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-sm mb-2"
                    ...
                    <option value="Good Recovery — slept well and felt refreshed">Good Recovery — slept well and felt refreshed</option>
                    <option value="Monitor — woke up once or twice">Monitor — woke up once or twice (urination/noise) but returned to sleep</option>
                    <option value="Poor Recovery — slept poorly">Poor Recovery — slept poorly, difficulty falling asleep</option>
                  </select>
                ...
                <div>
                  ...
                  <select className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-sm mb-2"
                    ...
                    <option value="Active — regular daily movement">Active — regular daily movement, &gt;5000 steps</option>
                    <option value="Low Activity — mostly sitting">Low Activity — mostly sitting, minimal walking</option>
                    <option value="Sedentary — bed rest / complete inactivity">Sedentary — bed rest / complete inactivity</option>
                  </select>
              ...
              <table className="w-full text-sm text-left">
                <thead className="bg-slate-50 text-slate-500 border-b border-slate-200 text-xs uppercase">
                  <tr>
                    ...
                    <th className="px-4 py-3 font-semibold">Vitals (Pre → Post)</th>
                    ...
                    <tr key={log.id} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-4 py-4">
                        <div className="text-xs text-slate-600">
                          <span className="inline-block w-8">BP:</span> {log.bp_systolic_pre}/{log.bp_diastolic_pre} → {log.bp_systolic_post}/{log.bp_diastolic_post}
                        </div>
                        <div className="text-xs text-slate-600">
                          <span className="inline-block w-8">HR:</span> {log.hr_pre} → {log.hr_post}
                        </div>
                      </td>
                      <td className="px-4 py-4">
