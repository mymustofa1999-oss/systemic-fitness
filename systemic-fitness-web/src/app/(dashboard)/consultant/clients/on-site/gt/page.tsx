...
import { UsersRound, Settings2, MapPin, Users } from "lucide-react";

export default function OnSiteGTPage() {
  return (
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-2">
            ...
            <span>Consultant / My Clients / On-site / Group Training</span>
          </div>
          ...
          <p className="text-slate-500 text-sm mt-1">Manage your on-site group training clients here.</p>
        </div>
