    ...
    <>
      ...
      {success ? (
        <div className="text-center">
          ...
          <h2 className="text-xl font-heading font-bold text-white mb-2">Password reset</h2>
        ...
        <>
          <div className="text-center mb-6">
            <h2 className="text-xl font-heading font-bold text-white">Set new password</h2>
            <p className="text-sm text-sf-iceBlue mt-1">Enter your new password below</p>
          </div>

          {error && (
            <div className="mb-4 p-3 rounded-xl bg-rose-500/10 border border-rose-500/20 text-center text-sm text-rose-400">
              {error}
            </div>
          )}
