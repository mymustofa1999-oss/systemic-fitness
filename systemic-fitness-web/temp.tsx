              ...
              {isLoading ? (
                ...
                assessments.map((a) => (
                  <tr key={a.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-4 py-3 border-r border-slate-200 text-[11px] text-slate-500 align-top">
                    ...
                    <td className="px-4 py-3 border-r border-slate-300 text-[11px] text-slate-500 align-top">
                      <ul className="space-y-1">
